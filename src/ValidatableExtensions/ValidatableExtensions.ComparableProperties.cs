...
public static partial class ValidatableExtensions
{
    ...
    /// <summary>
    /// Throws an exception if the value returned from the given <paramref name="func"/> is greater than or equal to <paramref name="n"/>.
    /// </summary>
    /// <remarks>
    /// The default exception thrown is an <see cref="ArgumentOutOfRangeException"/>.
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ref readonly Validatable<TValue> IfGreaterThanOrEqualTo<TValue, TResult>(
        this in Validatable<TValue> validatable,
        Func<TValue, TResult> func,
        TResult n,
        [CallerArgumentExpression("func")] string? funcName = null)
    ...
    /// <summary>
    /// Throws an exception if the value returned from the given <paramref name="func"/> is less than or equal to <paramref name="n"/>.
    /// </summary>
    /// <remarks>
    /// The default exception thrown is an <see cref="ArgumentOutOfRangeException"/>.
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ref readonly Validatable<TValue> IfLessThanOrEqualTo<TValue, TResult>(
        this in Validatable<TValue> validatable,
        Func<TValue, TResult> func,
        TResult n,
        [CallerArgumentExpression("func")] string? funcName = null)
    ...
    /// <summary>
    /// Throws an exception if the value returned from the given <paramref name="func"/> is greater than or equal to 0.
    /// </summary>
    /// <remarks>
    /// The default exception thrown is an <see cref="ArgumentOutOfRangeException"/>.
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ref readonly Validatable<TValue> IfPositiveOrZero<TValue, TResult>(
        this in Validatable<TValue> validatable,
        Func<TValue, TResult> func,
        [CallerArgumentExpression("func")] string? funcName = null)
            where TValue : notnull
    ...
    /// <summary>
    /// Throws an exception if the value returned from the given <paramref name="func"/> is less than or equal to 0.
    /// </summary>
    /// <remarks>
    /// The default exception thrown is an <see cref="ArgumentOutOfRangeException"/>.
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ref readonly Validatable<TValue> IfNegativeOrZero<TValue, TResult>(
        this in Validatable<TValue> validatable,
        Func<TValue, TResult> func,
        [CallerArgumentExpression("func")] string? funcName = null)
            where TValue : notnull
    ...
    /// <summary>
    /// Throws an exception if the value returned from the given <paramref name="func"/> is between <paramref name="min"/> and <paramref name="max"/>.
    /// </summary>
    /// <param name="validatable">The validatable being validated.</param>
    /// <param name="func">A function that will be applied on the value.</param>
    /// <param name="min">The minimum value, inclusive (equals or greater than).</param>
    ...
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ref readonly Validatable<TValue> IfInRange<TValue, TResult>(
        this in Validatable<TValue> validatable,
        Func<TValue, TResult> func,
        TResult min,
        TResult max,
